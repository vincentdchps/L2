              ...
              <span class="text-primary">
                ...
                <div class="space-y-4">
                    <form class="mb-4 space-y-4" action="{{ route('register') }}" method="POST">
                        ...
                        <div>
                            <label class="label-text" for="userLastname">Lastname*</label>
                            <input type="text" name="lastname" placeholder="Enter your lastname" class="input @error('lastname') input-error @enderror" id="userLastname" value="{{ old('lastname') }}" required />
                            @error('lastname')
                            <span class="text-error text-sm mt-1">{{ $message }}</span>
                            @enderror
                        </div>
